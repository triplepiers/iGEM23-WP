<template>
  <div class="blogBox">
    ...
    <div class="contentBox">
      <div class="contentTile">记录一次旅行 与旧友同游</div>
    </div>
  </div>
</template>
      ...
      someList: [
        {
          ...
          style: {
            background:
              'url(' + require('@/assets/nanjing1.jpg') + ')',
        ...
        },
        {
          ...
          style: {
            background:
              'url(' + require('@/assets/nanjing2.jpg') + ')',
            backgroundSize: "cover",
          },
        },
        {
          ...
          style: {
            background:
              'url(' + require('@/assets/nanjing3.jpg') + ')',
            backgroundSize: "cover",
          },
        },
      ],
